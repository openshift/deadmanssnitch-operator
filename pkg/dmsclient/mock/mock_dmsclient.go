...
//
//	mockgen -source=pkg/dmsclient/dmsclient.go -destination=pkg/dmsclient/mock/mock_dmsclient.go -package=mock_dmsclient
//
...
func (mr *MockClientMockRecorder) CheckIn(s any) *gomock.Call {
...
func (mr *MockClientMockRecorder) Create(newSnitch any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockClientMockRecorder) Delete(snitchToken any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockClientMockRecorder) FindSnitchesByName(snitchName any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockClientMockRecorder) List(snitchToken any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockClientMockRecorder) Update(updateSnitch any) *gomock.Call {
	mr.mock.ctrl.T.Helper()

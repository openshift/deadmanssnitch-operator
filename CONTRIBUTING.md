# Contributing to deadmanssnitch-operator

Thank you for your interest in contributing to this project.

## Quick Start

1. **Setup**: Install Go 1.25.4+
...
- Avoid editing generated files (`**/zz_generated.*.go`, `pkg/dmsclient/mock/mock_dmsclient.go`)
...
- GoMock (`go.uber.org/mock`) for interface mocking

## Testing Requirements

- **Unit tests required** for all new functionality
- Use standard Go testing with testify/assert for assertions
- Mock the DMS API client with GoMock (mock at `pkg/dmsclient/mock/`)
...
- `test: add unit tests for snitch reconciliation`

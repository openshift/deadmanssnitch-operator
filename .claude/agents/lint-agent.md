...
tools: Bash(make go-check), Bash(go fmt *), Bash(golangci-lint *), Read, Edit
model: sonnet
---
...
Example: controllers/deadmanssnitchintegration/deadmanssnitchintegration_controller.go:42 [govet] unreachable code
```

...
- `deadmanssnitch-operator-pull-request.yaml`: PR validation
- `deadmanssnitch-operator-push.yaml`: Main branch builds
- `deadmanssnitch-operator-pko-pull-request.yaml`: PKO validation
- `deadmanssnitch-operator-pko-push.yaml`: PKO deployment
...
# tkn pipeline validate -f .tekton/deadmanssnitch-operator-pull-request.yaml
...
```text
CI Status: FAILING
Pipeline: deadmanssnitch-operator-pull-request
Stage: golangci-lint
Error: Exit code 1

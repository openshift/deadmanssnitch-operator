...
- `controllers/deadmanssnitchintegration/deadmanssnitchintegration_controller.go` (main reconciler with secret handling)
...
Example: [HIGH] [SECRET] pkg/dmsclient/dmsclient.go:42: Hardcoded API key detected

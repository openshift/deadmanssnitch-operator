...
Quick reference for developing the Deadmanssnitch.
...
```bash
# Clone repository
git clone https://github.com/openshift/deadmanssnitch-operator.git
cd deadmanssnitch-operator
...
go test ./controllers/deadmanssnitchintegration/...  # Test specific package
...
```bash
# Run specific test
ginkgo -focus="NetworkPolicy" ./controllers/deadmanssnitchintegration/
...
- **Controllers**: `controllers/deadmanssnitchintegration/` - Reconciliation logic
- **Business Logic**: `controllers/deadmanssnitchintegration/` - Resource management
